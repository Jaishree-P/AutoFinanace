function CustomerModal({ customer, onClose }) {
  ...
  return (
    <div className='fixed inset-0 bg-black/70 flex justify-center items-center z-50 p-6'>
      ...
      <div className='bg-[#101826] border border-[#2A3344] rounded-3xl w-full max-w-7xl max-h-[95vh] overflow-y-auto p-8'>

        <div className='flex justify-between items-center mb-10'>

          <h1 className='text-4xl text-[#D6A64F]'>
            Customer Details
          </h1>
        ...
        <div className='grid md:grid-cols-2 gap-10'>
          ...
          <div>
            ...
            <div className='space-y-3 text-gray-300'>
              ...
              <a
                ...
                target='_blank'
                className='bg-cyan-400 text-black px-6 py-3 rounded-2xl inline-block font-bold mt-3'
              >
                Open In Google Maps
              </a>
          ...
          <div>
            ...
            <div className='flex flex-col gap-4'>
              ...
              <span className='bg-yellow-500/20 text-yellow-400 px-5 py-3 rounded-full'>
                Approval Status : {customer.approval_status}
              </span>

              <span className='bg-red-500/20 text-red-400 px-5 py-3 rounded-full'>
                Recovery Status : {customer.recovery_status}
              </span>

              <span className='bg-cyan-400/20 text-cyan-400 px-5 py-3 rounded-full'>
                Visit Status : {customer.visited_status}
              </span>

              {customer.visited_at && (
                <span className='bg-green-500/20 text-green-400 px-5 py-3 rounded-full'>
                  Visited At :
                  {' '}
        ...
        <div className='grid md:grid-cols-4 gap-6'>
          ...
          <div>
            ...
            <a
              ...
              target='_blank'
              className='bg-cyan-400 text-black flex justify-center items-center h-52 rounded-2xl font-bold'
            >
              Open Signature
            </a>
          </div>
